...
export const seedData: ControlRoomData = {
  ...
  drafts: [
    ...
    },
    {
      ...
      currency: "GBP",
      daysSilent: 92,
      contactEmail: "eleanor@blackwood.example",
      urgency: "medium",
      reason: "£84,200 LTV; 92 days inactive; lapsed score 775.8",
      proposedAction: "Send win-back email with 10% returning-customer incentive",
      expectedCashImpact: 12800,
      hoursToImpact: 184,
      confidence: 0.62,
      subject: "It's been a while: a small thank-you if you're back this month",
      body:
        "We would love to work together again. We can put together a refreshed quote with a 10% returning-customer incentive if there is a project you would like to restart this month.",
    },
    {
      id: "draft-r4",
      actionType: "reengagement_quote",
      agent: "reengagement",
      targetName: "Sable Interiors",
      targetId: "cust-56",
      currency: "GBP",
      daysSilent: 134,
      contactEmail: "james@sable.example",
      urgency: "high",
      reason: "£38,900 LTV; 134 days inactive; lapsed score 521.3",
      proposedAction: "Send voice-agent invite email — inactive 134 days (long-lapsed threshold)",
      expectedCashImpact: 7200,
      hoursToImpact: 268,
      confidence: 0.58,
      subject: "Let's reconnect, Sable Interiors",
      body:
        "It's been 134 days since we last worked together and we'd love to hear what you're planning next. Click below to speak with our reactivation agent — we can walk through a refreshed quote with a 10% returning-customer incentive if there's work to restart this month.",
    },
  ],
  audit: [
    {
