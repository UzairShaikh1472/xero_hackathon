  ...
  head: () => ({
    meta: [
      ...
      { title: "UpFlow" },
      {
        name: "description",
        content:
          "AI-powered liquidity and revenue acceleration for small businesses on Xero. Detect cash gaps, prioritise collections, and unlock lapsed revenue.",
      },
      { property: "og:title", content: "UpFlow" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700&family=Instrument+Serif:ital,wght@0,400;1,400&family=JetBrains+Mono:wght@500&display=swap",
      },
    ],
  }),
